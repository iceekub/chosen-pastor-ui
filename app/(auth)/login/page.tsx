...
// ── Six Seeds logo mark (inline so no extra network request) ──────────────
function SixSeedsMark({ size = 32 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 1024 1027" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
      ...
      <div className="relative anim-scaleIn" style={{ animationDelay: '0.05s', width: 'min(384px, calc(100vw - 2rem))', zIndex: 10 }}>
        ...
        <div className="mt-10 flex justify-center anim-fadeIn" style={{ animationDelay: '0.35s' }}>
          <p className="text-sm" style={{ color: 'rgba(181, 210, 173, 0.5)', fontFamily: 'var(--font-mulish)' }}>
            Need help?{' '}
            <a href="mailto:help@sixseeds.org" style={{ color: 'rgba(254, 236, 211, 0.6)', textDecoration: 'underline', cursor: 'pointer' }}>
              Contact us
            </a>
          </p>
        </div>
