...
export default function ResetPasswordPage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative anim-scaleIn" style={{ width: 'min(384px, calc(100vw - 2rem))', zIndex: 1 }}>
        <div className="flex justify-center items-center gap-3 mb-2 anim-fadeUp">
          <svg width="32" height="32" viewBox="0 0 1024 1027" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
        ...
        <p className="text-center mb-8 anim-fadeUp" style={{ fontFamily: 'var(--font-mulish)', fontSize: '1rem', fontWeight: 600, letterSpacing: '0.18em', color: '#B5D2AD' }}>
          CHURCH PORTAL
        </p>

        <div
          className="rounded-2xl px-7 py-7 anim-fadeUp"
          style={{ background: 'rgba(255,255,255,0.04)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 8px 40px rgba(0,0,0,0.3)' }}
        >
          {done ? (
            <div className="text-center py-4">
              <p className="text-sm font-semibold mb-2" style={{ color: '#FEECD3', fontFamily: 'var(--font-mulish)' }}>Password updated</p>
              <p className="text-sm" style={{ color: 'rgba(181,210,173,0.7)', fontFamily: 'var(--font-mulish)' }}>Redirecting you to sign in…</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-semibold mb-1.5" style={{ color: 'rgba(254,236,211,0.7)', fontFamily: 'var(--font-mulish)', letterSpacing: '0.07em', textTransform: 'uppercase' }}>
                  New password
                </label>
                <input
                  type="password"
              ...
              <button type="submit" disabled={saving} className="btn-seed w-full py-4 mt-1 group">
                <span>{saving ? 'Saving…' : 'Set new password'}</span>
                {!saving && (
