  ...
  return (
    <form action={action} className="space-y-8">
      ...
      <div className="surface px-6 py-6 anim-fadeUp" style={{ animationDelay: '0.08s' }}>
        <p className="section-label mb-4">Pastors</p>
        <input id="pastor_names" name="pastor_names" type="text"
          defaultValue={user.name}
          placeholder="Pastor John Smith"
          className="input-warm" />
        <p className="text-xs mt-1.5" style={{ color: '#A09080', fontFamily: 'var(--font-mulish)' }}>
          Multiple pastors? Separate with commas — e.g. Pastor John Smith, Rev. Sarah Lee.
        </p>
      </div>
