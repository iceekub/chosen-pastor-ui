    ...
    <aside className="sidebar flex flex-col w-64 h-screen sticky top-0 shrink-0 overflow-y-auto">
      ...
      <div className="px-3 pb-4 pt-3" style={{ borderTop: '1px solid rgba(79,113,71,0.35)' }}>
        ...
        <div className="mt-5 px-3 flex justify-center items-center gap-2">
          <svg width="20" height="20" viewBox="0 0 1024 1027" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.65, flexShrink: 0 }}>
          ...
          <span
            style={{ color: 'rgba(200,228,192,0.65)', fontFamily: 'var(--font-bellota)', fontWeight: 700, fontSize: '1.5rem', letterSpacing: '0.18em', textTransform: 'uppercase' }}
          >
            Six Seeds
          </span>
        </div>
...
function ChipIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M15.75 3v1.5M8.25 19.5V21M15.75 19.5V21M3 8.25h1.5M3 15.75h1.5M19.5 8.25H21M19.5 15.75H21M6.75 4.5h10.5a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25H6.75a2.25 2.25 0 01-2.25-2.25V6.75a2.25 2.25 0 012.25-2.25z" />
